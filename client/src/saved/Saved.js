                ...
                <div className="article-wrapper" key={i}>
                  <div className="panel panel-default" >
                    <div className="panel-body">
                      ...
                      <button type='button' className="btn btn-md btn-primary pull-right change-saved" style={{marginRight: '10px'}} onClick={() => props.openModal(saved._id, saved.title)}>Add Notes</button>
